...
| `crates/etv-station/src/catalog/` | Unified sqlite-backed catalog (#47) — the durable store query-based channels resolve against. Store + the ingesters that populate it (`ingest/`); the Plex ingester is still a separate unit (#91). |
